...
"for test_7_grep.txt test_8_grep.txt test_1_grep.txt VAR"
"for test_7_grep.txt VAR"
"-e for -e if test_7_grep.txt test_8_grep.txt test_1_grep.txt VAR"
"-e for -e else test_7_grep.txt VAR"
"-e regex -e print test_7_grep.txt VAR -f test_ptrn_grep.txt"
"-e while -e void test_7_grep.txt test_1_grep.txt VAR -f test_ptrn_grep.txt"
)
